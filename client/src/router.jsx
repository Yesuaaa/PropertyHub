...
import NoiseDisruptionIssue from './pages/NoiseDisruptionIssue';
import WorkstationIssue from './pages/WorkstationIssue';
import StaffServicesIssue from './pages/StaffServicesIssue';
...
export default function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/noise" element={<UserLayout><NoiseDisruptionIssue /></UserLayout>} />
      <Route path="/workstation" element={<UserLayout><WorkstationIssue /></UserLayout>} />
      <Route path="/staff" element={<UserLayout><StaffServicesIssue /></UserLayout>} />
      <Route path="/billing" element={<UserLayout><BillingIssue /></UserLayout>} />
      <Route path="/safety" element={<UserLayout><SafetyReport /></UserLayout>} />
      <Route path="/403" element={<UserLayout><Forbidden /></UserLayout>} />
