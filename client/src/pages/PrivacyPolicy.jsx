        ...
        <article className="bg-white border border-[#e6e2da] shadow-[0_0_0_1px_rgba(0,0,0,0.06)] px-5 sm:px-8 py-6 sm:py-10 text-[#1a1a1a]">
          <section className="space-y-4">
            ...
            <p className="text-sm text-[#5a6d78] leading-7">
              This Privacy Notice explains how PropertyHub Services collects, uses, stores, protects, and manages personal information through PropertyHub, our online Internet Cafe Complaint and Feedback System.
            </p>
            <p className="text-sm text-[#5a6d78] leading-7">
          ...
          <section className="mt-10 space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-[#5a6d78] leading-7">
                ...
                <li>Email: <a className="underline text-[#1a1a1a]" href="mailto:propertyhub@gmail.com">propertyhub@gmail.com</a></li>
